...
public class DataPro {
    ...
    public String processData(){
        ...
        double[] point = fingerSkin(bitmap);
    ...
    private int prePocessText(double[] point, String[][] data) {
        ...
        for (int i = 0; i < data.length; i++) {
            //将文字区域转换为int
            int top = Integer.parseInt(data[i][0]), left = Integer.parseInt(data[i][1])
                    , width = Integer.parseInt(data[i][2]), height = Integer.parseInt(data[i][3]);
